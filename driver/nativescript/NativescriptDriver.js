...
var NativescriptDriver = /** @class */ (function (_super) {
    ...
    function NativescriptDriver(connection) {
        ...
        if (_this.options.driverModule) {
            ...
            _this.driverModuleName = NativescriptDriver.DRIVER_MODULE_NAME;
        }
        // load sqlite package
    ...
    NativescriptDriver.prototype.loadDependencies = function () {
        try {
            ...
            throw new DriverPackageNotInstalledError_1.DriverPackageNotInstalledError("Nativescript", this.driverModuleName);
        }
    };
    NativescriptDriver.DRIVER_MODULE_NAME = "nativescript-sqlite";

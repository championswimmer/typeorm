...
var ReactNativeDriver = /** @class */ (function (_super) {
    ...
    function ReactNativeDriver(connection) {
        ...
        if (_this.options.driverModule) {
            _this.driverModuleName = _this.options.driverModule;
        }
        else {
            _this.driverModuleName = ReactNativeDriver.DRIVER_MODULE_NAME;
        }
        // load sqlite package
    ...
    ReactNativeDriver.prototype.loadDependencies = function () {
        try {
            ...
            throw new DriverPackageNotInstalledError_1.DriverPackageNotInstalledError("React-Native", this.driverModuleName);
        }
    };
    ReactNativeDriver.DRIVER_MODULE_NAME = "react-native-sqlite-storage";
